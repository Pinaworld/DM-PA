...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(esgi)
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(esgi));
        ...
        googleMap.addMarker(new MarkerOptions().position(third)
